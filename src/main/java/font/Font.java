...
public class Font {
    ...
    public void render(CharSequence text, float x, float y, float z,float rotx, float roty, Vector4f color) {
    ...
    public void render(CharSequence text, float x, float y) {
    	render(text, x, y, 0,0,0, new Vector4f(1,1,1,1));
    }
